	  ...
	  _createClass(GameView, [{
	    ...
	    value: function processMassAssign(cellX, cellY) {
	      ...
	      for (var delta = 1; delta <= 3; delta++) {
	        ...
	        this.pokeBattlefield.drawCell(battlefield[cellX + delta][cellY], this.stage, this.squareSize, cellX + delta, cellY);
	
	        this.pokeBattlefield.assignCell(cellX + delta, cellY + delta, this.typeToAssign);
	        this.pokeBattlefield.drawCell(battlefield[cellX + delta][cellY + delta], this.stage, this.squareSize, cellX + delta, cellY + delta);
	
	        this.pokeBattlefield.assignCell(cellX, cellY + delta, this.typeToAssign);
	        this.pokeBattlefield.drawCell(battlefield[cellX][cellY + delta], this.stage, this.squareSize, cellX, cellY + delta);
