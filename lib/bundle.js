	...
	var GameView = function () {
	  ...
	  _createClass(GameView, [{
	    ...
	    value: function handleAssign() {
	      ...
	      this.pokeBattlefield.assignCell(cellX, cellY);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = function () {
	  ...
	  _createClass(Board, [{
	    ...
	    key: "assignCell",
	    value: function assignCell(cellX, cellY) {
	      this.grid[cellX][cellY] = new _poke_cell2.default("WATER");
	    }
	  }, {
	    key: "battle",
	    ...
	    value: function battleNeighbors(neighbors) {
	      ...
	      neighbors.forEach(function (attacker) {
	        ...
	        if (_this.HP <= 0) {
	          ...
	          _this.damageFromType = defaultDamageStandings;
	        }
	      });
	    }
	  }, {
